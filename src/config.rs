...
pub fn get_config() -> ScrypeSettings {
    ...
    let config_data: serde_json::Result<ScrypeSettings> = serde_json::from_reader(config_file);
...
pub fn get_macro_config(name: &str) -> MacroConfig {
    ...
    let config_data: serde_json::Result<MacroConfig> = serde_json::from_reader(config_file);
